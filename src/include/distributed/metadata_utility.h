...
extern void MarkSequenceListDistributedAndPropagateDependencies(Oid relationId,
																List *sequenceList);
extern void MarkSequenceDistributedAndPropagateDependencies(Oid relationId, Oid
															sequenceOid);
