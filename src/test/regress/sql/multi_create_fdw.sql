...
-- here we set ddl propagation to off
-- the two lines in between should not be propagated,
-- as they are already created on workers in pg_regress_multi.pl
-- see: https://github.com/citusdata/citus/pull/5468#discussion_r761919808
